...
> {
    pub protected: InlinedCbor<KbtProtected<IssuerProtectedClaims, IssuerUnprotectedClaims, IssuerPayloadClaims, ProtectedClaims, DisclosedClaims>>,
...
> {
    ...
    pub kcwt: InlinedCbor<SdCwtIssuedTagged<IssuerProtectedClaims, IssuerUnprotectedClaims, IssuerPayloadClaims, DisclosedClaims>>,
    #[builder(default)]
...
impl<
    ...
    PayloadClaims: CustomClaims,
    DisclosedClaims: CustomClaims,
> KbtCwt<IssuerProtectedClaims, IssuerUnprotectedClaims, IssuerPayloadClaims, ProtectedClaims, UnprotectedClaims, PayloadClaims, DisclosedClaims>
{
...
pub type KbtCwtTagged<IssuerProtectedClaims, IssuerUnprotectedClaims, IssuerPayloadClaims, ProtectedClaims, UnprotectedClaims, PayloadClaims, DisclosedClaims> =
